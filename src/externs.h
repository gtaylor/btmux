...
char *parse_arglist(dbref, dbref, char *, char, long, char *[], long, char *[], long);
...
void atr_add(dbref, int, char *, dbref, long);
void atr_set_owner(dbref, int, dbref);
void atr_set_flags(dbref, int, long);
char *atr_get_raw(dbref, int);
char *atr_get(dbref, int, dbref *, long *);
char *atr_pget(dbref, int, dbref *, long *);
char *atr_get_str(char *, dbref, int, dbref *, long *);
char *atr_pget_str(char *, dbref, int, dbref *, long *);
int atr_get_info(dbref, int, dbref *, long *);
int atr_pget_info(dbref, int, dbref *, long *);
void atr_free(dbref);
