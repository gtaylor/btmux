...
NAMETAB cstatus_sw[] = {
	{(char *) "full", 0, CA_PUBLIC, CSTATUS_FULL},
	{NULL, 0, 0, 0}
};
...
CMDENT command_table[] = {
	...
	{(char *) "@boot", boot_sw, CA_NO_GUEST | CA_NO_SLAVE, 0,
	 CS_ONE_ARG | CS_INTERP, do_boot},
	{(char *) "@cboot", NULL, CA_NO_SLAVE | CA_NO_GUEST, 0, CS_TWO_ARG,
	 do_chboot},
	{(char *) "@ccharge", NULL, CA_NO_SLAVE | CA_NO_GUEST, 1, CS_TWO_ARG,
	 do_editchannel},
	{(char *) "@cchown", NULL, CA_NO_SLAVE | CA_NO_GUEST, 0, CS_TWO_ARG,
	 do_editchannel},
	{(char *) "@ccreate", NULL, CA_NO_SLAVE | CA_NO_GUEST, 0, CS_ONE_ARG,
	 do_createchannel},
	{(char *) "@cdestroy", NULL, CA_NO_SLAVE | CA_NO_GUEST, 0, CS_ONE_ARG,
	 do_destroychannel},
	{(char *) "@cemit", cemit_sw, CA_NO_SLAVE | CA_NO_GUEST, 0, CS_TWO_ARG,
	 do_cemit},
	{(char *) "@chown", NULL, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD,
	 CHOWN_ONE, CS_TWO_ARG | CS_INTERP, do_chown},
	{(char *) "@chownall", NULL, CA_WIZARD | CA_GBL_BUILD, CHOWN_ALL,
	 CS_TWO_ARG | CS_INTERP, do_chownall},
	{(char *) "@chzone", NULL, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD, 0,
	 CS_TWO_ARG | CS_INTERP, do_chzone},
	{(char *) "@clone", clone_sw,
	...
	{(char *) "@cpattr", NULL, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD, 0,
	 CS_TWO_ARG | CS_ARGV, do_cpattr},
	{(char *) "@cpflags", NULL, CA_NO_SLAVE, 3, CS_TWO_ARG, do_editchannel},
	{(char *) "@create", NULL,
	 CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS | CA_NO_GUEST,
	 0, CS_TWO_ARG | CS_INTERP, do_create},
	{(char *) "@cset", cset_sw, CA_NO_SLAVE, 0, CS_TWO_ARG | CS_INTERP,
	 do_chopen},
	...
	{(char *) "@decompile", decomp_sw, 0, 0, CS_TWO_ARG | CS_INTERP,
	 do_decomp},
	...
	{(char *) "@dig", dig_sw, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD,
	 0, CS_TWO_ARG | CS_ARGV | CS_INTERP, do_dig},
	{(char *) "@disable", NULL, CA_WIZARD, GLOB_DISABLE, CS_ONE_ARG,
	 do_global},
	{(char *) "@doing", doing_sw, CA_PUBLIC, 0, CS_ONE_ARG, do_doing},
	{(char *) "@dolist", dolist_sw, CA_GBL_INTERP,
	 0, CS_TWO_ARG | CS_CMDARG | CS_NOINTERP | CS_STRIP_AROUND | CS_NO_MACRO,
	 do_dolist},
	{(char *) "@drain", NULL, CA_GBL_INTERP | CA_NO_SLAVE | CA_NO_GUEST,
	 NFY_DRAIN, CS_TWO_ARG, do_notify},
	{(char *) "@dump", dump_sw, CA_WIZARD, 0, CS_NO_ARGS, do_dump},
	{(char *) "@edit", NULL, CA_NO_SLAVE | CA_NO_GUEST, 0,
	 CS_TWO_ARG | CS_ARGV | CS_STRIP_AROUND, do_edit},
	{(char *) "@emit", emit_sw, CA_LOCATION | CA_NO_GUEST | CA_NO_SLAVE,
	 SAY_EMIT, CS_ONE_ARG | CS_INTERP, do_say},
	{(char *) "@enable", NULL, CA_WIZARD, GLOB_ENABLE, CS_ONE_ARG, do_global},
	{(char *) "@entrances", NULL, CA_NO_GUEST, 0, CS_ONE_ARG | CS_INTERP,
	 do_entrances},
	{(char *) "@femit", femit_sw, CA_LOCATION | CA_NO_GUEST | CA_NO_SLAVE,
	 PEMIT_FEMIT, CS_TWO_ARG | CS_INTERP, do_pemit},
	{(char *) "@find", NULL, 0, 0, CS_ONE_ARG | CS_INTERP, do_find},
	{(char *) "@fixdb", fixdb_sw, CA_GOD, 0, CS_TWO_ARG | CS_INTERP,
	 do_fixdb},
	/*{(char *)"@fnd", NULL, 0, 0, CS_ONE_ARG|CS_UNPARSE, do_fnd}, */
	{(char *) "@force", NULL, CA_NO_SLAVE | CA_GBL_INTERP | CA_NO_GUEST,
	 FRC_COMMAND, CS_TWO_ARG | CS_INTERP | CS_CMDARG | CS_NO_MACRO, do_force},
	{(char *) "@fpose", fpose_sw, CA_LOCATION | CA_NO_SLAVE, PEMIT_FPOSE,
	 CS_TWO_ARG | CS_INTERP, do_pemit},
	{(char *) "@fsay", NULL, CA_LOCATION | CA_NO_SLAVE, PEMIT_FSAY,
	 CS_TWO_ARG | CS_INTERP, do_pemit},
	{(char *) "@function", function_sw, CA_GOD, 0, CS_TWO_ARG | CS_INTERP,
	 do_function},
	{(char *) "@halt", halt_sw, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP,
	 do_halt},
	{(char *) "@kick", NULL, CA_WIZARD, QUEUE_KICK, CS_ONE_ARG | CS_INTERP,
	 do_queue},
	{(char *) "@last", NULL, CA_NO_GUEST, 0, CS_ONE_ARG | CS_INTERP, do_last},
	{(char *) "@link", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST,
	...
	{(char *) "@lock", lock_sw, CA_NO_SLAVE, 0, CS_TWO_ARG | CS_INTERP,
	 do_lock},
#ifdef ARBITRARY_LOGFILES
	{(char *) "@log", NULL, CA_WIZARD, 0, CS_TWO_ARG, do_log},
#endif
	{(char *) "@mail", mail_sw, CA_NO_SLAVE | CA_NO_GUEST | CA_NO_IC, 0,
	...
	{(char *) "@name", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST, 0,
	 CS_TWO_ARG | CS_INTERP, do_name},
	{(char *) "@newpassword", NULL, CA_WIZARD, PASS_ANY, CS_TWO_ARG,
	 do_newpassword},
	{(char *) "@notify", notify_sw, CA_GBL_INTERP | CA_NO_SLAVE | CA_NO_GUEST,
	 0, CS_TWO_ARG, do_notify},
	{(char *) "@oemit", NULL, CA_LOCATION | CA_NO_GUEST | CA_NO_SLAVE,
	...
	{(char *) "@password", NULL, CA_NO_GUEST, PASS_MINE, CS_TWO_ARG,
	 do_password},
	{(char *) "@pcreate", NULL, CA_WIZARD | CA_GBL_BUILD, PCRE_PLAYER,
	 CS_TWO_ARG, do_pcreate},
	{(char *) "@pemit", pemit_sw, CA_NO_GUEST | CA_NO_SLAVE, PEMIT_PEMIT,
	 CS_TWO_ARG | CS_INTERP, do_pemit},
	{(char *) "@npemit", pemit_sw, CA_NO_GUEST | CA_NO_SLAVE, PEMIT_PEMIT,
	 CS_TWO_ARG | CS_UNPARSE, do_pemit},
	...
	{(char *) "@robot", NULL,
	 CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST | CA_PLAYER, PCRE_ROBOT,
	 CS_TWO_ARG, do_pcreate},
	{(char *) "@search", NULL, 0, SRCH_SEARCH, CS_ONE_ARG | CS_NOINTERP,
	 do_search},
	{(char *) "@set", set_sw, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST, 0,
	 CS_TWO_ARG, do_set},
	...
	{(char *) "@switch", switch_sw, CA_GBL_INTERP, 0,
	 ...
	 do_switch},
	{(char *) "@teleport", teleport_sw, CA_NO_GUEST, TELEPORT_DEFAULT,
	 CS_TWO_ARG | CS_INTERP, do_teleport},
	{(char *) "@timewarp", warp_sw, CA_WIZARD, 0, CS_ONE_ARG | CS_INTERP,
	 do_timewarp},
	{(char *) "@toad", toad_sw, CA_WIZARD, 0, CS_TWO_ARG | CS_INTERP,
	 do_toad},
	{(char *) "@trigger", trig_sw, CA_GBL_INTERP, 0, CS_TWO_ARG | CS_ARGV,
	 do_trigger},
	{(char *) "@unlink", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
	 CS_ONE_ARG | CS_INTERP, do_unlink},
	{(char *) "@unlock", lock_sw, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP,
	 do_unlock},
	{(char *) "@verb", NULL, CA_GBL_INTERP | CA_NO_SLAVE, 0,
	...
	{(char *) "@wait", NULL, CA_GBL_INTERP, 0,
	 ...
	 do_wait},
	{(char *) "@wall", wall_sw, CA_ANNOUNCE, SAY_SHOUT,
	 CS_ONE_ARG | CS_INTERP, do_say},
	{(char *) "@wipe", wall_sw, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD, 0,
	 CS_ONE_ARG | CS_INTERP, do_wipe},
	{(char *) "addcom", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_TWO_ARG,
	 do_addcom},
	{(char *) "allcom", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_ONE_ARG,
	 do_allcom},
	{(char *) "comlist", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_NO_ARGS,
	 do_comlist},
	{(char *) "comtitle", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_TWO_ARG,
	 do_comtitle},
	{(char *) "clearcom", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_NO_ARGS,
	 do_clearcom},
	{(char *) "delcom", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_ONE_ARG,
	 do_delcom},
	{(char *) "drop", drop_sw,
	...
	{(char *) "enter", enter_sw, CA_LOCATION, 0, CS_ONE_ARG | CS_INTERP,
	 do_enter},
	{(char *) "examine", examine_sw, 0, 0, CS_ONE_ARG | CS_INTERP,
	 do_examine},
	{(char *) "get", get_sw, CA_LOCATION | CA_NO_GUEST, 0,
	 CS_ONE_ARG | CS_INTERP, do_get},
	...
	{(char *) "whisper", NULL, CA_LOCATION | CA_NO_SLAVE, PEMIT_WHISPER,
	 CS_TWO_ARG | CS_INTERP, do_pemit},
	 ...
	 int mask;
{
	...
	if(!Wizard(player) && (((mask & CA_NO_HAVEN) && Player_haven(player))
						   ...
						   (!mudconf.btech_ooc_comsys && (mask & CA_NO_IC)
							&& In_IC_Loc(player)) || ((mask & CA_NO_IC)
													  && Gagged(player))
	   ))
		return 0;
	return 1;
...
#define	Protect(x) (cmdp->perms & x)
	...
	if((cmdp->callseq & CS_INTERP) || !(interactive ||
				...
				for(add = (ADDENT *) cmdp->handler; add != NULL;
					...
					*s++ = '\0';
					...
					if(wild(buff + 1, new, aargs, 10)) {
						wait_que(add->thing, player, 0, NOTHING, 0, s,
								 aargs, 10, mudstate.global_regs);
						for(i = 0; i < 10; i++) {
							if(aargs[i])
								free_lbuf(aargs[i]);
						}
		...
		*bp = '\0';
		...
		if(cmdp->callseq & CS_ARGV) {
			...
			parse_arglist(player, cause, arg, '\0',
						  interp | EV_STRIP_LS | EV_STRIP_TS, args, MAX_ARG,
						  cargs, ncargs);
	...
	*bp = '\0';
	...
	if(Has_location(player)) {
		...
		if(!(No_Command(Location(player))))
			if(atr_match(Location(player), player, AMATCH_CMD, lcbuf, 1) > 0) {
				succ++;
			}
	}
...
int cf_access(int *vp, char *str, long extra, dbref player, char *cmd)
{
	...
	if(cmdp != NULL) {
		if(set_switch)
			return cf_ntab_access((int *) cmdp->switches, ap, extra,
								  player, cmd);
		else
...
static void list_options(dbref player)
{
	...
	raw_notify(player,
			   tprintf
			   ("Earning money is difficult if you have more than %d %s.",
...
static void list_vattrs(dbref player)
{
	...
	raw_notify(player, tprintf("%d attributes, next=%d", na,
							   mudstate.attr_next));
	free_lbuf(buff);
}
...
static void list_process(dbref player)
{
	...
	if(dur > 0) {
		ixrss =
			(mudstate.mstat_ixrss[curr] - mudstate.mstat_ixrss[last]) / dur;
		idrss =
			(mudstate.mstat_idrss[curr] - mudstate.mstat_idrss[last]) / dur;
		isrss =
			(mudstate.mstat_isrss[curr] - mudstate.mstat_isrss[last]) / dur;
	} else {
		ixrss = 0;
		idrss = 0;
		isrss = 0;
	...
	raw_notify(player,
			   tprintf("Process ID:  %10d        %10d bytes per page", pid,
					   psize));
#ifdef HAVE_GETRUSAGE
